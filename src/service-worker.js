...
const toCache = shell.concat(
  files.map(fn => (fn === 'service-worker-index.html' ? fn : `assets/${fn}`))
);
...
self.addEventListener('fetch', event => {
  ...
  // file, which Sapper has generated for you. It's not right for every app, but
  // if it's right for yours then uncomment this section.
  /*
  if (
